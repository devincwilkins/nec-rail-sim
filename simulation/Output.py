...
def outputFigs(out_path, vehicleInfo, stops):
        ...
        columns=['time','id','route','state','speed','track', \
        ...
        colors = {'1':'g','2':'g','3':'b','4':'b','5':'r','6':'r','7':'y','8':'y','9':'m','10':'m','11':'c','12':'c','13':'k','14':'k','15':'burlywood','16':'burlywood','17':'chartreuse','18':'chartreuse','39':'#000080','40':'#000080','41':'#000040','42':'#000040'}
        ...
        ax1.set_yticks(stopLocation_5['Stop Location'])
        ax1.set_yticklabels(stopLocation_5['Stop Name'].map(lambda x: x.rstrip('_5')), fontsize = 20)
        ...
        plt.savefig(out_path + 'runGraph.png', transparent=True)
